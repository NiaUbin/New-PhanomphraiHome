                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-end p-8">
                      <div className="translate-y-4 group-hover:translate-y-0 transition-all duration-500 w-full">
                        ...
                        <span className="font-mono text-[11px] uppercase tracking-[0.2em] text-white flex items-center gap-3 font-bold group/link bg-primary/20 backdrop-blur-sm w-fit px-4 py-2 rounded-full border border-white/10 hover:bg-primary active:scale-95 transition-all">
                          ดูโครงการ <span className="text-lg transition-transform duration-300 group-hover/link:translate-x-1">→</span>
                        </span>
                      </div>
                    </div>
                  </Link>
